...
const APR_COLOR: Record<string, string> = {
  '14.1%':  'var(--green)',
  '47.2%':  'var(--amber)',
  '124.7%': 'var(--red)',
}
...
const POOLS: Pool[] = [
  { name: 'BNB / BUSD', fee: '0.05%', badge: 'BLUE-CHIP', tvl: '$1.08T',  vol: '$1.24M', apr: '14.1%' },
  { name: 'CAKE / BNB', fee: '0.25%', badge: 'MID-CAP',   tvl: '$2.40T',  vol: '$320K',  apr: '47.2%', arb: true },
  { name: 'ETH / USDC', fee: '0.05%', badge: 'DEGEN',     tvl: '$720M',   vol: '$78K',   apr: '124.7%' },
]
        ...
        {POOLS.map((pool, i) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span
                  ...
                  style={{ fontFamily: 'var(--font-mono)', ...BADGE_STYLES[pool.badge] }}
                >
                  {pool.badge}
                </span>

                {/* ARB DETECTED — pulsing */}
                {pool.arb && (
                  <motion.span
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                { label: 'TVL',      value: pool.tvl,  color: 'var(--text-primary)' },
                { label: 'VOL 24H',  value: pool.vol,  color: 'var(--text-secondary)' },
                { label: 'FEE APR',  value: pool.apr,  color: APR_COLOR[pool.apr] ?? 'var(--green)' },
              ].map(m => (
